...
public final class Texture extends DrawingArea {
	...
	public static final Texture get(int index) {
		...
		if (cache[index] == null) {
			Main.onDemandFetcher.method558(4, index);
			return null;
		}
		return cache[index];
	}
	...
	public static void method374(int y1, int y2, int y3, int x1, int x2,
			int x3, int hsl1, int hsl2, int hsl3) {
		drawLDGouraudTriangle(y1, y2, y3, x1, x2, x3, hsl1, hsl2, hsl3);
	}

	public static void drawLDGouraudTriangle(int y1, int y2, int y3, int x1,
			int x2, int x3, int hsl1, int hsl2, int hsl3) {
		int j2 = 0;
		int k2 = 0;
		if (y2 != y1) {
			j2 = (x2 - x1 << 16) / (y2 - y1);
			...
			if (y2 < y3) {
				...
				if (y1 != y2 && j3 < j2 || y1 == y2 && j3 > l2) {
					...
					for (y1 = anIntArray1472[y1]; --y2 >= 0; y1 += DrawingArea.width) {
						drawLDGouraudScanline(DrawingArea.pixels, y1, x3 >> 16,
								x1 >> 16, hsl3 >> 7, hsl1 >> 7);
						x3 += j3;
						x1 += j2;
						hsl3 += k3;
				...
				y2 -= y1;
				for (y1 = anIntArray1472[y1]; --y2 >= 0; y1 += DrawingArea.width) {
					drawLDGouraudScanline(DrawingArea.pixels, y1, x1 >> 16,
							x3 >> 16, hsl1 >> 7, hsl3 >> 7);
					x3 += j3;
					x1 += j2;
					hsl3 += k3;
				...
				while (--y3 >= 0) {
					drawLDGouraudScanline(DrawingArea.pixels, y1, x2 >> 16,
							x3 >> 16, hsl2 >> 7, hsl3 >> 7);
					x3 += j3;
					x2 += l2;
					hsl3 += k3;
			...
			if (y3 < y1) {
				...
				if (y2 != y3 && j2 < l2 || y2 == y3 && j2 > j3) {
					...
					for (y2 = anIntArray1472[y2]; --y3 >= 0; y2 += DrawingArea.width) {
						drawLDGouraudScanline(DrawingArea.pixels, y2, x1 >> 16,
								x2 >> 16, hsl1 >> 7, hsl2 >> 7);
						x1 += j2;
						x2 += l2;
						hsl1 += k2;
				...
				y3 -= y2;
				for (y2 = anIntArray1472[y2]; --y3 >= 0; y2 += DrawingArea.width) {
					drawLDGouraudScanline(DrawingArea.pixels, y2, x2 >> 16,
							x1 >> 16, hsl2 >> 7, hsl1 >> 7);
					x1 += j2;
					x2 += l2;
					hsl1 += k2;
				...
				while (--y1 >= 0) {
					drawLDGouraudScanline(DrawingArea.pixels, y2, x3 >> 16,
							x1 >> 16, hsl3 >> 7, hsl1 >> 7);
					x1 += j2;
					x3 += j3;
					hsl1 += k2;
		...
		if (y1 < y2) {
			...
			if (l2 < j3) {
				...
				for (y3 = anIntArray1472[y3]; --y1 >= 0; y3 += DrawingArea.width) {
					drawLDGouraudScanline(DrawingArea.pixels, y3, x2 >> 16,
							x3 >> 16, hsl2 >> 7, hsl3 >> 7);
					x2 += l2;
					x3 += j3;
					hsl2 += i3;
			...
			y1 -= y3;
			for (y3 = anIntArray1472[y3]; --y1 >= 0; y3 += DrawingArea.width) {
				drawLDGouraudScanline(DrawingArea.pixels, y3, x3 >> 16,
						x2 >> 16, hsl3 >> 7, hsl2 >> 7);
				x2 += l2;
				x3 += j3;
				hsl2 += i3;
			...
			while (--y2 >= 0) {
				drawLDGouraudScanline(DrawingArea.pixels, y3, x1 >> 16,
						x2 >> 16, hsl1 >> 7, hsl2 >> 7);
				x2 += l2;
				x1 += j2;
				hsl2 += i3;
		...
		y2 -= y3;
		for (y3 = anIntArray1472[y3]; --y2 >= 0; y3 += DrawingArea.width) {
			drawLDGouraudScanline(DrawingArea.pixels, y3, x3 >> 16, x1 >> 16,
					hsl3 >> 7, hsl1 >> 7);
			x1 += l2;
			x3 += j3;
			hsl1 += i3;
		...
		while (--y1 >= 0) {
			drawLDGouraudScanline(DrawingArea.pixels, y3, x3 >> 16, x2 >> 16,
					hsl3 >> 7, hsl2 >> 7);
			x2 += j2;
			x3 += j3;
			hsl2 += k2;
	...
	private static void drawLDGouraudScanline(int[] ai, int i, int l, int i1,
                                              int j1, int k1) {
		int j;// was parameter
		int k;// was parameter
		if (aBoolean1464) {
	...
	public static void drawHDGouraudTriangle(int y1, int y2, int y3, int x1,
			int x2, int x3, int hsl1, int hsl2, int hsl3) {
		...
		if (y1 <= y2 && y1 <= y3) {
			...
			if (y2 < y3) {
				...
				if (y1 != y2 && dx3 < dx1 || y1 == y2 && dx3 > dx2) {
					...
					y2 -= y1;
					for (y1 = anIntArray1472[y1]; --y2 >= 0; y1 += DrawingArea.width) {
						drawHDGouraudScanline(DrawingArea.pixels, y1, x3 >> 16,
								x1 >> 16, r3, g3, b3, r1, g1, b1);
						x3 += dx3;
						x1 += dx1;
						r3 += dr3;
						g3 += dg3;
				...
				y2 -= y1;
				for (y1 = anIntArray1472[y1]; --y2 >= 0; y1 += DrawingArea.width) {
					drawHDGouraudScanline(DrawingArea.pixels, y1, x1 >> 16,
							x3 >> 16, r1, g1, b1, r3, g3, b3);
					x3 += dx3;
					x1 += dx1;
					r3 += dr3;
					g3 += dg3;
				...
				while (--y3 >= 0) {
					drawHDGouraudScanline(DrawingArea.pixels, y1, x2 >> 16,
							x3 >> 16, r2, g2, b2, r3, g3, b3);
					x3 += dx3;
					x2 += dx2;
					r3 += dr3;
					g3 += dg3;
		...
		if (y2 <= y3) {
			...
			if (y3 < y1) {
				...
				if (y2 != y3 && dx1 < dx2 || y2 == y3 && dx1 > dx3) {
					...
					y3 -= y2;
					for (y2 = anIntArray1472[y2]; --y3 >= 0; y2 += DrawingArea.width) {
						drawHDGouraudScanline(DrawingArea.pixels, y2, x1 >> 16,
								x2 >> 16, r1, g1, b1, r2, g2, b2);
						x1 += dx1;
						x2 += dx2;
						r1 += dr1;
				...
				y3 -= y2;
				for (y2 = anIntArray1472[y2]; --y3 >= 0; y2 += DrawingArea.width) {
					drawHDGouraudScanline(DrawingArea.pixels, y2, x2 >> 16,
							x1 >> 16, r2, g2, b2, r1, g1, b1);
					x1 += dx1;
					x2 += dx2;
					r1 += dr1;
				...
				while (--y1 >= 0) {
					drawHDGouraudScanline(DrawingArea.pixels, y2, x3 >> 16,
							x1 >> 16, r3, g3, b3, r1, g1, b1);
					x1 += dx1;
					x3 += dx3;
					r1 += dr1;
		...
		if (y1 < y2) {
			...
			if (dx2 < dx3) {
				...
				y1 -= y3;
				for (y3 = anIntArray1472[y3]; --y1 >= 0; y3 += DrawingArea.width) {
					drawHDGouraudScanline(DrawingArea.pixels, y3, x2 >> 16,
							x3 >> 16, r2, g2, b2, r3, g3, b3);
					x2 += dx2;
					x3 += dx3;
					r2 += dr2;
			...
			y1 -= y3;
			for (y3 = anIntArray1472[y3]; --y1 >= 0; y3 += DrawingArea.width) {
				drawHDGouraudScanline(DrawingArea.pixels, y3, x3 >> 16,
						x2 >> 16, r3, g3, b3, r2, g2, b2);
				x2 += dx2;
				x3 += dx3;
				r2 += dr2;
			...
			while (--y2 >= 0) {
				drawHDGouraudScanline(DrawingArea.pixels, y3, x1 >> 16,
						x2 >> 16, r1, g1, b1, r2, g2, b2);
				x2 += dx2;
				x1 += dx1;
				r2 += dr2;
		...
		y2 -= y3;
		for (y3 = anIntArray1472[y3]; --y2 >= 0; y3 += DrawingArea.width) {
			drawHDGouraudScanline(DrawingArea.pixels, y3, x3 >> 16, x1 >> 16,
					r3, g3, b3, r1, g1, b1);
			x1 += dx2;
			x3 += dx3;
			r1 += dr2;
		...
		while (--y1 >= 0) {
			drawHDGouraudScanline(DrawingArea.pixels, y3, x3 >> 16, x2 >> 16,
					r3, g3, b3, r2, g2, b2);
			x2 += dx1;
			x3 += dx3;
			r2 += dr1;
	...
	public static void drawHDGouraudScanline(int[] dest, int offset, int x1,
			int x2, int r1, int g1, int b1, int r2, int g2, int b2) {
		int n = x2 - x1;
		if (n <= 0) {
			return;
		}
		...
		if (x1 < x2) {
			...
			if (anInt1465 == 0) {
				while (--n >= 0) {
					dest[offset] = (r1 & 0xff0000) | (g1 >> 8 & 0xff00)
							| (b1 >> 16 & 0xff);
					r1 += r2;
					g1 += g2;
					b1 += b2;
				...
				int dst;
				while (--n >= 0) {
					rgb = (r1 & 0xff0000) | (g1 >> 8 & 0xff00)
							| (b1 >> 16 & 0xff);
					rgb = ((rgb & 0xff00ff) * a2 >> 8 & 0xff00ff)
							+ ((rgb & 0xff00) * a2 >> 8 & 0xff00);
					dst = dest[offset];
					dest[offset] = rgb
							+ ((dst & 0xff00ff) * a1 >> 8 & 0xff00ff)
	...
	public static void method378(int i, int j, int k, int l, int i1, int j1,
		...
		drawLDTexturedTriangle(i, j, k, l, i1, j1, k1, l1, i2, j2, k2, l2, i3,
				j3, k3, l3, i4, j4, k4);

	}

	public static void drawLDTexturedTriangle(int i, int j, int k, int l,
			int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2,
			int i3, int j3, int k3, int l3, int i4, int j4, int k4) {
        int[] ai = method371(k4);
		...
		if (i <= j && i <= k) {
			...
			if (j < k) {
				...
				if (i != j && i8 < i7 || i == j && i8 > k7) {
					...
					i = anIntArray1472[i];
					while (--j >= 0) {
						drawLDTexturedScanline(DrawingArea.pixels, ai, i,
								j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5,
								j6, i5, l5, k6);
						j1 += i8;
						l += i7;
						i2 += j8;
				...
				i = anIntArray1472[i];
				while (--j >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, i, l >> 16,
				...
				while (--k >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, i, i1 >> 16,
			...
			if (i != k && i8 < i7 || i == k && k7 > i7) {
				...
				while (--j >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, i, j1 >> 16,
		...
		if (j <= k) {
			...
			if (k < i) {
				...
				if (j != k && i7 < k7 || j == k && i7 > i8) {
					...
					j = anIntArray1472[j];
					while (--k >= 0) {
						drawLDTexturedScanline(DrawingArea.pixels, ai, j,
								l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5,
								j6, i5, l5, k6);
						l += i7;
						i1 += k7;
						k1 += j7;
				...
				j = anIntArray1472[j];
				while (--k >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, j, i1 >> 16,
							l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
					l += i7;
					i1 += k7;
					k1 += j7;
				...
				while (--i >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, j, j1 >> 16,
							l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
					l += i7;
					j1 += i8;
					k1 += j7;
			...
			if (i7 < k7) {
				...
				while (--k >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, j, l >> 16,
							i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
					l += i8;
					i1 += k7;
					k1 += j8;
		...
		if (i < j) {
			...
			if (k7 < i8) {
				...
				k = anIntArray1472[k];
				while (--i >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, k, i1 >> 16,
							j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
					i1 += k7;
					j1 += i8;
					l1 += l7;
			...
			k = anIntArray1472[k];
			while (--i >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, k, j1 >> 16,
						i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
				i1 += k7;
				j1 += i8;
				l1 += l7;
			...
			while (--j >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, k, l >> 16,
						i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
				i1 += k7;
				l += i7;
				l1 += l7;
	...
	private static void drawLDTexturedScanline(int[] ai, int[] ai1, int k,
	...
	public static void drawHDTexturedTriangle(int y1, int y2, int y3, int x1,
			int x2, int x3, int l1, int l2, int l3, int tx1, int tx2, int tx3,
			int ty1, int ty2, int ty3, int tz1, int tz2, int tz3, int tex) {
		l1 = 0x7f - l1 << 1;
		l2 = 0x7f - l2 << 1;
		l3 = 0x7f - l3 << 1;
		...
		if (y1 <= y2 && y1 <= y3) {
			...
			if (y2 < y3) {
				...
				if (y1 != y2 && i8 < i7 || y1 == y2 && i8 > k7) {
					...
					while (--y2 >= 0) {
						drawHDTexturedScanline(DrawingArea.pixels, ai, y1,
								x3 >> 16, x1 >> 16, l3, l1, l4, k5, j6, i5, l5,
								k6);
						x3 += i8;
						x1 += i7;
						l3 += j8;
					...
					while (--y3 >= 0) {
						drawHDTexturedScanline(DrawingArea.pixels, ai, y1,
								x3 >> 16, x2 >> 16, l3, l2, l4, k5, j6, i5, l5,
								k6);
						x3 += i8;
						x2 += k7;
						l3 += j8;
				...
				while (--y2 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y1,
							x1 >> 16, x3 >> 16, l1, l3, l4, k5, j6, i5, l5, k6);
					x3 += i8;
					x1 += i7;
					l3 += j8;
					l1 += j7;
				...
				while (--y3 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y1,
							x2 >> 16, x3 >> 16, l2, l3, l4, k5, j6, i5, l5, k6);
					x3 += i8;
					x2 += k7;
					l3 += j8;
					l2 += l7;
			...
			if (y1 != y3 && i8 < i7 || y1 == y3 && k7 > i7) {
				...
				while (--y3 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y1,
							x2 >> 16, x1 >> 16, l2, l1, l4, k5, j6, i5, l5, k6);
					x2 += i8;
					x1 += i7;
					l2 += j8;
					l1 += j7;
				...
				while (--y2 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y1,
							x3 >> 16, x1 >> 16, l3, l1, l4, k5, j6, i5, l5, k6);
					x3 += k7;
					x1 += i7;
					l3 += l7;
					l1 += j7;
			...
			y1 = anIntArray1472[y1];
			while (--y3 >= 0) {
				drawHDTexturedScanline(DrawingArea.pixels, ai, y1, x1 >> 16,
						x2 >> 16, l1, l2, l4, k5, j6, i5, l5, k6);
				x2 += i8;
				x1 += i7;
				l2 += j8;
				l1 += j7;
		...
		if (y2 <= y3) {
			...
			if (y3 < y1) {
				...
				if (y2 != y3 && i7 < k7 || y2 == y3 && i7 > i8) {
					...
					while (--y3 >= 0) {
						drawHDTexturedScanline(DrawingArea.pixels, ai, y2,
								x1 >> 16, x2 >> 16, l1, l2, l4, k5, j6, i5, l5,
								k6);
						x1 += i7;
						x2 += k7;
						l1 += j7;
					...
					while (--y1 >= 0) {
						drawHDTexturedScanline(DrawingArea.pixels, ai, y2,
								x1 >> 16, x3 >> 16, l1, l3, l4, k5, j6, i5, l5,
								k6);
						x1 += i7;
						x3 += i8;
						l1 += j7;
			...
			if (i7 < k7) {
				...
				while (--y1 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y2,
							x3 >> 16, x2 >> 16, l3, l2, l4, k5, j6, i5, l5, k6);
					x3 += i7;
					x2 += k7;
					l3 += j7;
					l2 += l7;
				...
				while (--y3 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y2,
							x1 >> 16, x2 >> 16, l1, l2, l4, k5, j6, i5, l5, k6);
					x1 += i8;
					x2 += k7;
					l1 += j8;
					l2 += l7;
			...
			y2 = anIntArray1472[y2];
			while (--y1 >= 0) {
				drawHDTexturedScanline(DrawingArea.pixels, ai, y2, x2 >> 16,
						x3 >> 16, l2, l3, l4, k5, j6, i5, l5, k6);
				x3 += i7;
				x2 += k7;
				l3 += j7;
				l2 += l7;
		...
		if (y1 < y2) {
			...
			if (k7 < i8) {
				...
				while (--y1 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y3,
							x2 >> 16, x3 >> 16, l2, l3, l4, k5, j6, i5, l5, k6);
					x2 += k7;
					x3 += i8;
					l2 += l7;
			...
			y3 = anIntArray1472[y3];
			while (--y1 >= 0) {
				drawHDTexturedScanline(DrawingArea.pixels, ai, y3, x3 >> 16,
						x2 >> 16, l3, l2, l4, k5, j6, i5, l5, k6);
				x2 += k7;
				x3 += i8;
				l2 += l7;
				l3 += j8;
			...
			while (--y2 >= 0) {
				drawHDTexturedScanline(DrawingArea.pixels, ai, y3, x1 >> 16,
						x2 >> 16, l1, l2, l4, k5, j6, i5, l5, k6);
				x2 += k7;
				x1 += i7;
				l2 += l7;
		...
		if (k7 < i8) {
			...
			while (--y1 >= 0) {
				drawHDTexturedScanline(DrawingArea.pixels, ai, y3, x2 >> 16,
						x3 >> 16, l2, l3, l4, k5, j6, i5, l5, k6);
				x2 += i7;
				x3 += i8;
				l2 += j7;
	...
	private static void drawHDTexturedScanline(int[] ai, int[] ai1, int k,
                                               int x1, int x2, int l1, int l2, int a1, int i2, int j2, int k2,
                                               int a2, int i3) {
		int i = 0;// was parameter
		int j = 0;// was parameter
		if (x1 >= x2)
		...
		if (lowMem) {
			...
			if (aBoolean1463) {
				...
				while (n-- > 0) {
					rgb = ai1[(j & 0xfc0) + (i >> 6)];
					l = l1 >> 16;
					ai[k++] = ((rgb & 0xff00ff) * l & ~0xff00ff)
							+ ((rgb & 0xff00) * l & 0xff0000) >> 8;
					i += i7;
					j += k7;
					l1 += dl;
					rgb = ai1[(j & 0xfc0) + (i >> 6)];
			...
			while (n-- > 0) {
				...
				if ((k8 = ai1[(j & 0xfc0) + (i >> 6)]) != 0) {
					l = l1 >> 16;
					ai[k] = ((k8 & 0xff00ff) * l & ~0xff00ff)
							+ ((k8 & 0xff00) * l & 0xff0000) >> 8;
				}
				k++;
				i += i7;
				j += k7;
			...
			for (n = x2 - x1 & 7; n-- > 0;) {
				...
				if ((l8 = ai1[(j & 0xfc0) + (i >> 6)]) != 0) {
					l = l1 >> 16;
					ai[k] = ((l8 & 0xff00ff) * l & ~0xff00ff)
							+ ((l8 & 0xff00) * l & 0xff0000) >> 8;
				}
				k++;
				i += i7;
				j += k7;
		...
		while (n-- > 0) {
			...
			if ((i9 = ai1[(j & 0x3f80) + (i >> 7)]) != 0) {
				l = l1 >> 16;
				ai[k] = ((i9 & 0xff00ff) * l & ~0xff00ff)
						+ ((i9 & 0xff00) * l & 0xff0000) >> 8;
            }
			k++;
			i += j7;
			j += l7;
		...
		for (int l3 = x2 - x1 & 7; l3-- > 0;) {
			...
			if ((j9 = ai1[(j & 0x3f80) + (i >> 7)]) != 0) {
				l = l1 >> 16;
				ai[k] = ((j9 & 0xff00ff) * l & ~0xff00ff)
						+ ((j9 & 0xff00) * l & 0xff0000) >> 8;
            }
			k++;
			i += j7;
			j += l7;
