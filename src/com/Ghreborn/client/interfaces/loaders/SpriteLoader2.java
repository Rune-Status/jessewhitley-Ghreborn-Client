...
public class SpriteLoader2 {
	...
	public static void loadSprites() {
		try {
			Buffer index = new Buffer(FileOperations.ReadFile(SignLink.findcachedir() + "media_archives/media_archive2.idx"));
			Buffer data = new Buffer(FileOperations.ReadFile(SignLink.findcachedir() + "media_archives/media_archive2.dat"));
