package com.Ghreborn.client.interfaces.impl.ge;
...
public class GrandExchange extends Widget {
	...
	public static void initializeInterfaces(RSFont[] var271) {
		mainInterface(var271);
		addBuyAndSellButtons(var271);
		addItemBoxes(var271);
		
		buyAndSellBackground(var271);
		buyScreen(var271);
		sellScreen(var271);
		
		offerStatusBackground(var271);
		addOfferStatusInterfaces(var271);
		
		collectInterface(var271);
	}
	...
	private static void mainInterface(RSFont[] tda) {
		...
		setBounds(65017, 380, 196, 11, widget);
	}
	...
	private static void addBuyAndSellButtons(RSFont[] tda) {
		Widget widget;
		int childId = 0;
		for(int index = 0; index < grandExchangeBuyAndSellBoxIds.length; index++) {
			...
			addHoverButton(childId + 2, "Interfaces/GE/IMAGE", 3, 47, 46, "Create <col=0xff7000>buy offer", 0, childId + 3, 1);
			...
			addHoverButton(childId + 5, "Interfaces/GE/IMAGE", 5, 47, 46, "Create <col=0xff7000>sell offer", 0, childId + 6, 1);
	...
	private static void addItemBoxes(RSFont[] tda) {
		Widget widget;
		int childId = 0;
	...
	private static void buyScreen(RSFont[] tda) {
		Widget widget = addInterface(25600);
	...
	private static void sellScreen(RSFont[] tda) {
		Widget widget = addInterface(25650);
		final int startX = 20, startY = 13;
	...
	private static void buyAndSellBackground(RSFont[] tda) {
	...
	private static void offerStatusBackground(RSFont[] tda) {
		Widget widget = addInterface(25700);
	...
	private static void addOfferStatusInterfaces(RSFont[] tda) {
		Widget widget;
		int childId = 0;
	...
	private static void collectInterface(RSFont[] tda) {
