...
public class Xml$ implements ActionListener, KeyListener {
   ...
   public Xml$(URL xmlURL) {
      try {
         URLConnection var31 = xmlURL.openConnection();
         var31.setRequestProperty("User-Agent", "Mozilla");
         var31.connect();
         this.readStream(var31.getInputStream());
   ...
   public Xml$(String fileName) {
      ...
      try {
         FileInputStream var41 = new FileInputStream(file);
         this.readStream(var41);
   ...
   private void initUI() {
      ...
      for(int var81 = 0; var81 < this.itemName.length && this.itemName[var81] != null; ++var81) {
         if(foundOne) {
            this.namePanel.append(newLine + this.itemName[var81]);
            this.idPanel.append(newLine + this.itemID[var81]);
         } else {
            foundOne = true;
            this.namePanel.append(this.itemName[var81]);
            this.idPanel.append(this.itemID[var81]);
         }
      }
