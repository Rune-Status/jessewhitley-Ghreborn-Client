...
public class rsDrawingArea extends DrawingArea {
   ...
   public static void method1417(int drawX, int drawY, int width, int height, int color) {
      ...
      if(height == 0) {
         ...
         if(width > height) {
            ...
            drawY += '\u8000';
            height <<= 16;
            i_10_ = (int)Math.floor((double)height / (double)width + 0.5D);
            width += drawX;
            if(drawX < topX) {
               drawY += i_10_ * (topX - drawX);
               drawX = topX;
            }
            ...
            while(drawX <= width) {
               i_11_ = drawY >> 16;
               if(i_11_ >= topY && i_11_ < bottomY) {
                  pixels[drawX + i_11_ * width] = color;
               }
            ...
            drawX += '\u8000';
            width <<= 16;
            i_10_ = (int)Math.floor((double)width / (double)height + 0.5D);
            height += drawY;
            if(drawY < topY) {
   ...
   public static void clearDrawingArea() {
      ...
      int i_12_;
      for(i_12_ = width * height - 7; i < i_12_; pixels[i++] = 0) {
         pixels[i++] = 0;
         pixels[i++] = 0;
         pixels[i++] = 0;
         pixels[i++] = 0;
      ...
      for(i_12_ += 7; i < i_12_; pixels[i++] = 0) {
      }
   ...
   public static void drawVerticalLineAlpha(int drawX, int drawY, int lineHeightI, int color, int alpha) {
      if(drawX >= topX && drawX < bottomX) {
         ...
         int tempRed = (color >> 16 & 255) * alpha;
         int tempGreen = (color >> 8 & 255) * alpha;
         int tempblue = (color & 255) * alpha;
         int currentPixel = drawX + drawY * width;

         for(int count = 0; count < lineHeightI; ++count) {
            int finalRed = (pixels[currentPixel] >> 16 & 255) * realAlpha;
            int finalGreen = (pixels[currentPixel] >> 8 & 255) * realAlpha;
            int finalBlue = (pixels[currentPixel] & 255) * realAlpha;
   ...
   public static void method1425(int i, int i_35_, int i_36_, int i_37_) {
      if(i_36_ == 0) {
         ...
         while(i_40_ < i_35_) {
            ...
            i_52_ = i_50_ + i_40_ * width;

            for(i_53_ = i_50_; i_53_ < i_51_; ++i_53_) {
               pixels[i_52_++] = i_37_;
            }
         ...
         for(i_45_ -= i_43_; i_40_ < i_39_; i_44_ += i_43_++ + i_43_) {
            while(i_45_ > i_41_ && i_44_ > i_41_) {
               i_45_ -= i_42_-- + i_42_;
               i_44_ -= i_42_ + i_42_;
            }
   ...
   public static void drawHorizontalLineAlpha(int i, int i_89_, int i_90_, int i_91_, int i_92_) {
      if(i_89_ >= topY && i_89_ < bottomY) {
         ...
         int i_93_ = 256 - i_92_;
         int i_94_ = (i_91_ >> 16 & 255) * i_92_;
         int i_95_ = (i_91_ >> 8 & 255) * i_92_;
         int i_96_ = (i_91_ & 255) * i_92_;
         int i_97_ = i + i_89_ * width;

         for(int i_98_ = 0; i_98_ < i_90_; ++i_98_) {
            int i_99_ = (pixels[i_97_] >> 16 & 255) * i_93_;
            int i_100_ = (pixels[i_97_] >> 8 & 255) * i_93_;
            int i_101_ = (pixels[i_97_] & 255) * i_93_;
   ...
   public static void method1434(int i, int i_114_, int i_115_, int i_116_, int i_117_) {
      if(i_117_ != 0) {
         if(i_117_ == 256) {
            ...
            int i_119_ = (i_116_ >> 16 & 255) * i_117_;
            int i_120_ = (i_116_ >> 8 & 255) * i_117_;
            int i_121_ = (i_116_ & 255) * i_117_;
            ...
            int i_145_;
            while(i_124_ < i_114_) {
               while(i_129_ <= i_125_ || i_128_ <= i_125_) {
               ...
               i_140_ = i_138_ + i_124_ * width;

               for(i_141_ = i_138_; i_141_ < i_139_; ++i_141_) {
                  i_142_ = (pixels[i_140_] >> 16 & 255) * i_118_;
                  i_143_ = (pixels[i_140_] >> 8 & 255) * i_118_;
                  i_144_ = (pixels[i_140_] & 255) * i_118_;
                  i_145_ = (i_119_ + i_142_ >> 8 << 16) + (i_120_ + i_143_ >> 8 << 8) + (i_121_ + i_144_ >> 8);
            ...
            i_128_ = i_129_ - i_115_;

            for(i_129_ -= i_127_; i_124_ < i_123_; i_128_ += i_127_++ + i_127_) {
               while(i_129_ > i_125_ && i_128_ > i_125_) {
                  i_129_ -= i_126_-- + i_126_;
                  i_128_ -= i_126_ + i_126_;
               }
   ...
   public static void fillBoxAlpha(int i, int i_146_, int i_147_, int i_148_, int i_149_, int i_150_) {
      ...
      i_149_ = ((i_149_ & 16711935) * i_150_ >> 8 & 16711935) + ((i_149_ & '\uff00') * i_150_ >> 8 & '\uff00');
      ...
      for(int i_154_ = 0; i_154_ < i_148_; ++i_154_) {
         for(int i_155_ = -i_147_; i_155_ < 0; ++i_155_) {
            ...
            i_156_ = ((i_156_ & 16711935) * i_151_ >> 8 & 16711935) + ((i_156_ & '\uff00') * i_151_ >> 8 & '\uff00');
   ...
   public static void method1437(int drawX, int drawY, int boxWidth, int boxHeight, int color, int alpha) {
      ...
      for(int i_166_ = -boxHeight; i_166_ < 0; ++i_166_) {
         ...
         int i_168_ = i_162_ >> 8;
         int finalColor = ((color & 16711935) * i_167_ + (alpha & 16711935) * i_168_ & -16711936) + ((color & '\uff00') * i_167_ + (alpha & '\uff00') * i_168_ & 16711680) >>> 8;
