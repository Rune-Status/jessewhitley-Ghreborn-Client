...
public class CacheDownloader {
	...
	public enum FileType {
		CACHE(SignLink.findcachedir(),"http://ghreborn.com/cache/cache.zip",15),
		MODELS(SignLink.findcachedir(),"http://ghreborn.com/cache/models.zip",6),
		FILEDATA(SignLink.findcachedir(),"http://ghreborn.com/cache/filedata.zip", 6),
		SOUNDS(SignLink.findcachedir(),"http://ghreborn.com/cache/sounds.zip",1);
		/**
	 ...
	 */
	private static void downloadFile(Main client, FileType type,
	 ...
	 */
	public static void start(Main Client, FileType type) {
		try {
