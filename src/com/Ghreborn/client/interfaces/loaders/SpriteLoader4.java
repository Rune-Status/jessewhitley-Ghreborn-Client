...
public class SpriteLoader4 {
	...
	public static void loadSprites() {
		try {
			Buffer index = new Buffer(FileOperations.ReadFile(SignLink.findcachedir() + "media_archives/media_archive4.idx"));
			Buffer data = new Buffer(FileOperations.ReadFile(SignLink.findcachedir() + "media_archives/media_archive4.dat"));
