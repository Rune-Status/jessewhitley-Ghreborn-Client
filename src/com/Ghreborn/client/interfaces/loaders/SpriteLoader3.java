...
public class SpriteLoader3 {
	...
	public static void loadSprites() {
		try {
			Buffer index = new Buffer(FileOperations.ReadFile(SignLink.findcachedir() + "media_archives/media_archive3.idx"));
			Buffer data = new Buffer(FileOperations.ReadFile(SignLink.findcachedir() + "media_archives/media_archive3.dat"));
