...
public final class CollisionMap {
      ...
      if(j == i && k == k1) {
         ...
         if(j1 == 9) {
            ...
            if(j == i - 1 && k == k1 && (this.anIntArrayArray294[j][k] & 8) == 0) {
             ...
             return j == i + 1 && k == k1 && (this.anIntArrayArray294[j][k] & 128) == 0;
         }
      ...
      if(j1 == i && k == j) {
         ...
         if(l == 8) {
            ...
            if(j1 == i - 1 && k == j && (this.anIntArrayArray294[j1][k] & 8) == 0) {
             ...
             return j1 == i + 1 && k == j && (this.anIntArrayArray294[j1][k] & 128) == 0;
         }
   ...
   public boolean method221(int i, int j, int k, int l, int i1, int j1, int k1) {
      int l1 = j + j1 - 1;
      int i2 = i + l - 1;
      return k >= j && k <= l1 && k1 >= i && k1 <= i2 || (k == j - 1 && k1 >= i && k1 <= i2 && (this.anIntArrayArray294[k - this.anInt290][k1 - this.anInt291] & 8) == 0 && (i1 & 8) == 0 || (k == l1 + 1 && k1 >= i && k1 <= i2 && (this.anIntArrayArray294[k - this.anInt290][k1 - this.anInt291] & 128) == 0 && (i1 & 2) == 0 || (k1 == i - 1 && k >= j && k <= l1 && (this.anIntArrayArray294[k - this.anInt290][k1 - this.anInt291] & 2) == 0 && (i1 & 4) == 0 || k1 == i2 + 1 && k >= j && k <= l1 && (this.anIntArrayArray294[k - this.anInt290][k1 - this.anInt291] & 32) == 0 && (i1 & 1) == 0)));
   }
}
